...
import { getAuth, connectAuthEmulator, setPersistence, browserLocalPersistence, signInWithCustomToken, signOut } from "https://www.gstatic.com/firebasejs/11.7.1/firebase-auth.js";
...
firebase.signOut = async () => {
	...
	try {
		await request("POST", new URL(`${localEnvironment ? "/wixonic-website-2/europe-west1/httpServer" : ""}/auth/revoke/`, window.localEnvironment ? path.local.functions : path.functions), "json", "application/json", null, -1, true);
		location.reload();
	} catch (e) {
